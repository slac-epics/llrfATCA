...
class ComplexWindow(Display):
    ...
    def addChannels(self, variable, choice):
        ...
        #plot.addChannel(y_address, x_address, color = 'white', lineWidth = 3, name = 'Average Window', yAxisName='Average Window')
        #plot.addChannel(y_address, x_address, color = 'red', lineWidth = 2, name = 'Average Window')
        plot.addChannel(y_address, x_address, color = QColor(255,50,50), lineWidth = 3, name = 'Average Window', yAxisName='Average Window')

        y_address = 'ca://' + self._device + wf + str(choice)

        plot.addChannel(y_address, x_address, color = 'cyan', lineWidth = 3, name = 'Measurement', yAxisName='Measurement')
        #plot.addChannel(y_address, x_address, color = 'blue', lineWidth = 2, name = 'Measurement')
        #plot.addChannel(y_address, x_address, color = QColor(100,100,255), lineWidth = 3, name = 'Measurement', yAxisName='Measurement')
    ...
    def ui_filename(self):
        ...
        """
        return 'hls_complex_window_pau.ui'
